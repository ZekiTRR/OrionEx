        ...
        try
        {
            switch (selection)
            {
                ...
                case "Sentinel":
                    ...
                    break;
                case "Velocity":
                    ShowPreservedAvaloniaWindow(new VelocityWindow(
                        _orionMonacoServer.Address,
                        _orionWorkspace.ScriptsDirectory,
                        workspace,
                        RestoreOrionWorkspace));
                ...
                case "SirHurtV5Remake":
                    ...
                    break;
                case "JJSploit":
                    ShowPreservedAvaloniaWindow(new JJSploitWindow(
                        _orionMonacoServer.Address,
                        _orionWorkspace.ScriptsDirectory,
                        workspace,
                        RestoreOrionWorkspace));
    ...
    private void RestoreOrionWorkspace(EditorWorkspaceState workspace)
    {
        ...
        Dispatcher.UIThread.Post(async () =>
        {
            ...
            try
            {
                ...
                else if (returningWindow is VelocityWindow velocity)
                {
                    velocity.CloseForOrion();
                }
